...
print(f"gpuid: {args.modeldir[0]}")
print(f"gpuid: {args.model[0]}")
print(f"gpuid: {args.savedir[0]}")
print(f"gpuid: {args.targetrow[0]}")
print(f"gpuid: {args.sequence[0]}")
print(f"gpuid: {args.seqclass[0]}")
print("\n\n\n\n\n\n\n\n\n")
